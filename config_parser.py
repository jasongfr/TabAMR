...
def get_args_parser():
    ...
    parser.add_argument("--dataset_type", default="wikievent", choices=["ace_eeqa", "rams", "wikievent", 'MLEE'], type=str,
    ...
    parser.add_argument('--matching_method_train', default="accurate", choices=["max", 'accurate'], type=str,
    ...
    parser.add_argument('--model_type', default='paie')
