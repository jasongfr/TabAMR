...
def eval_std_f1_score(features, invalid_gt_num=0):
    ...
    for feature in features:
        for (roles, gt_dict_word, pred_dict_word) in zip(feature.list_roles, feature.gt_dict_word, feature.pred_dict_word):
            all_pred_list = list()
            all_gt_list = list()
            for role in roles:
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        ...
        for feature in features:
            ...
            for (event_type, event_trigger, roles, pred_dict_word, gt_dict_word) in \
                zip(feature.list_event_type, feature.list_event_trigger, feature.list_roles, feature.pred_dict_word, feature.gt_dict_word):
                f.write("-------------------------------------------------------------------------------------\n")
