...
def build_model(args):
    ...
    config.context_representation = args.context_representation #whether use the full BART (decoder) or only BART-encoder (encoder) to represent the context.
    ...
    tokenizer.add_tokens(['spatial', 'temporal', 'means', 'Arg', 'prepositions', '<node>', '(', ')', 'Arg-of'])
